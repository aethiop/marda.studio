...
(function () {
	...
	edide.set = function (edide, set) {
		Object.defineProperty(this, "module_name", { value: "set" });
	...
	edide.membrameSynth = function (edide, membrameSynth) {
		Object.defineProperty(this, "module_name", { value: "membrameSynth" });
		this.startNote = "A0";
	...
	edide.toneSynth = function (edide, toneSynth) {
		Object.defineProperty(this, "module_name", { value: "toneSynth" });
		this.startNote = "C3";
	...
	edide.instrumentConfigs = function (edide, instrumentConfigs) {
		var configs = {
			...
			casio: {
				startNote: "A1",
				baseUrl: "https://github.com/Tonejs/audio/tree/master/casio/",
			},
	...
	edide.noteFreq = function (edide, noteFreq) {
		Object.defineProperty(this, "module_name", { value: "noteFreq" });
	...
	edide.inEditor = function (edide, inEditor) {
		Object.defineProperty(this, "module_name", { value: "inEditor" });
	...
	edide.keep = function (edide, keep) {
		Object.defineProperty(this, "module_name", { value: "keep" });
		var keep;
	...
	edide.logProd = function (edide, logProd) {
		return (...args) => {
			...
			console =
				(ref =
					(ref1 = edide.editorModule) != null
						? ref1.console
						: void 0) != null
					? ref
					: edide.global.console;
	...
	edide.onUnload = function (edide, onUnload) {
		...
		return (ref =
			(ref1 = edide.editorModule) != null ? ref1.unload.add : void 0) !=
			null
			? ref
			: () => {};
	}.call((MODSELF = {}), edide, MODSELF);
	...
	edide.mmState = function (edide, mmState) {
		Object.defineProperty(this, "module_name", { value: "mmState" });
	...
	edide.mmEffects = function (edide, mmEffects) {
		Object.defineProperty(this, "module_name", { value: "mmEffects" });
	...
	edide.mmConfigs = function (edide, mmConfigs) {
		Object.defineProperty(this, "module_name", { value: "mmConfigs" });
		...
		this.hasVar = (varName) => {
			var ref, ref1;
			return !!((ref =
				(ref1 = vars[varName]) != null
					? ref1
					: mutatingVars[varName]) != null
				? ref
		...
		this.reset = () => {
			stateVars.forEach((name) => {
				return (edide.mmState.revar[name] =
					edide.mmState.defaults[name]);
			});
		};
	...
	edide.setTimeout = function (edide, mod_setTimeout) {
		...
		return function (arg1, arg2) {
			var fun, id, num;
			[fun, num] =
				typeof arg2 === "function" ? [arg2, arg1] : [arg1, arg2];
	...
	edide.musicScales = function (edide, musicScales) {
		Object.defineProperty(this, "module_name", { value: "musicScales" });
		this.full = [
			"C",
			"C#",
			"D",
	...
	edide.mathOp = function (edide, mathOp) {
		Object.defineProperty(this, "module_name", { value: "mathOp" });
	...
	edide.mmKeyboard = function (edide, mmKeyboard) {
		Object.defineProperty(this, "module_name", { value: "mmKeyboard" });
		var A,
			a,
			char,
			chari,
		...
		this.specialKeyCodes = new Set(
			Object.values(this.special).map((s) => {
		...
		this.abc = (key, baseInd) => {
			...
			noteInd += revar.scaleSteps
				.slice(0, +stepsFromClosestOctave + 1 || 9e9)
	...
	edide.chars = function (edide, chars) {
		Object.defineProperty(this, "module_name", { value: "chars" });
		this.space = " ";
	...
	edide.showError = function (edide, showError) {
		...
		error = (err) => {
			if (edide.inEditor) {
				...
				return edide.global[
					edide.edideNamespace
				].prodErrorPrinter.showError(err);
			} else {
	...
	edide.mmParserSpecial = function (edide, mmParserSpecial) {
		...
		this.var = (track, trackState) => {
			...
			varLength = track
				.slice(i + 1)
				.indexOf(edide.mmKeyboard.special.var);
			if (varLength === -1) {
				return false;
			}
	...
	edide.mmNote = function (edide, mmNote) {
		Object.defineProperty(this, "module_name", { value: "mmNote" });
		this.fromChar = (char) => {
		...
		this.fromKeyCode = (key) => {
			var noteInd, ref;
			if (
				typeof (noteInd = edide.mmKeyboard.getNoteInd(key)) === "number"
			) {
	...
	edide.mmParser = function (edide, mmParser) {
		Object.defineProperty(this, "module_name", { value: "mmParser" });
	...
	edide.moduleGate = function (edide, moduleGate) {
		Object.defineProperty(this, "module_name", { value: "moduleGate" });
		if (!edide.inEditor) {
			return this;
		}
	...
	edide.promise = function (edide, promise) {
		Object.defineProperty(this, "module_name", { value: "promise" });
		var localPromise, ref;

		localPromise = edide.global.origPromise =
			(ref = edide.global.origPromise) != null
				? ref
				: edide.global.Promise;
	...
	edide.requireScript = function (edide, requireScript) {
		...
		return (scriptSrc) => {
			...
			if ((promise = requireScriptPromises.get(scriptSrc))) {
				...
				requireScriptPromises.set(
					scriptSrc,
					(promise = edide.promise.new((resolve) => {
	...
	edide.mmPipe = function (edide, mmPipe) {
		Object.defineProperty(this, "module_name", { value: "mmPipe" });
	...
	edide.mmInstruments = function (edide, mmInstruments) {
		Object.defineProperty(this, "module_name", { value: "mmInstruments" });
		...
		this.isReady = () => {
			...
			return (
				current &&
				(typeof current.loaded == "undefined" ||
					current.loaded === true)
			);
		};
	...
	edide.mmInstrument = function (edide, mmInstrument) {
		Object.defineProperty(this, "module_name", { value: "mmInstrument" });
		var cloneOrCreateInstrument,
			getInstruments,
			instruments,
			play,
			react,
		...
		react("create first instrument", () => {
			...
			if (
				!(name =
					(ref = revar.instrumentConf) != null ? ref.name : void 0)
			) {
				// e.g. illegal instrument name
				return edide.showError(
					`Unknown instrument: ${unvar.instrument}`
				);
			}
		...
		cloneOrCreateInstrument = (name) => {
			var inst;
			inst = instruments[name][0].soundFontInstrument
	...
	edide.mmPlayer = function (edide, mmPlayer) {
		Object.defineProperty(this, "module_name", { value: "mmPlayer" });
	...
	edide.waves = function (edide, waves) {
		Object.defineProperty(this, "module_name", { value: "waves" });
	...
	edide.global.waves = edide.waves;
})();
